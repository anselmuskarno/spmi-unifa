      ...
      <div class="sidebar-inner slimscroll">
        <div id="sidebar-menu" class="sidebar-menu">
          <div class="header-left">
            <a href="/dashboardKaprodi" onclick="return confirm('Apakah Anda yakin ingin meninggalkan halaman ini? Jawaban Anda tidak akan disimpan!');" class="logo">
          ...
          <ul class="sidebar-ul">
            ...
            <li class="">
              <a href="/dashboardKaprodi" onclick="return confirm('Apakah Anda yakin ingin meninggalkan halaman ini? Jawaban Anda tidak akan disimpan!');"><img src="admin2/assets/img/sidebar/icon-1.png" alt="icon"><span>Dashboard</span></a>
            </li>
            <li class="">
              <a href="/hasilKaprodi" onclick="return confirm('Apakah Anda yakin ingin meninggalkan halaman ini? Jawaban Anda tidak akan disimpan!');"><img src="admin2/assets/img/sidebar/icon-10.png" alt="icon">
